  ...
  return (
    <Card>
      <CardContent className="grid gap-5">
        <CardTitle className="text-center text-[#CDFF3A]">Mafia Swap</CardTitle>
        <hr />
        <div className="space-y-2">
          ...
          <Input
            ...
            className={cn({
              "text-destructive !ring-destructive": insufficientBalance,
            })}
          />
        ...
        <div className="flex justify-center">
          <Button
            className="border text-gray-950 bg-[#CDFF3A] border-input"
            variant={"ghost"}
            size={"icon"}
        ...
        <div className="space-y-2">
          ...
          <Input value={amount1} readOnly={true} placeholder="0.0" />
        </div>
        <div className="flex items-center justify-between gap-4 font-medium">
          <SettingModal
            trigger={
              <button className="flex items-center gap-2 text-[#CDFF3A] hover:text-[#CDFF3A]/80">
                Slippage Tolerance <PencilLineIcon size={20} />
              </button>
            }
          />

          <span className="text-[#CDFF3A] hover:text-[#CDFF3A]/80">{slippageTolerance}%</span>
        </div>
        <Button className="h-12 py-4 font-semibold uppercase border border-[#CDFF3A] bg-gradient-to-br from-lime-400 to-lime-700" disabled={disableButton} onClick={submit}>
          {buttonTitle}
        </Button>
      </CardContent>
